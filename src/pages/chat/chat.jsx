    ...
    return (
        <PopupsContext.Provider value={{ popActive, setPopActive }}>
            <div className="single-page overflow-y-clip py-3 flex ">
                <div className="ml-2 relative side-menu-container">
                    <AnimatePresence>
                        <div
                            className="toggle p-2 z-10 fixed top-5 left-5 rounded-full"
                ...
                <div className="body flex-1 flex flex-col items-start">
                    ...
                    >
                        ...
                        {profilePopup ? (
                            ...
                            initial="close"
                            animate="open"
                            className="profile-pp z-50">
                                <Profile setProfilePopup={setProfilePopup}/>
                            </motion.div>
                        ) : null}
                        </AnimatePresence>
                        <AnimatePresence>
                            ...
                            {chatStarted && (
                                <div className="conv w-full h-full flex-1">
                                    <Conversation
                                        title="random joke"
