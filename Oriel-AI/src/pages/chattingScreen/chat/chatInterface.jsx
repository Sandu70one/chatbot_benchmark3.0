...
export const ChatInterface = () => {
  ...
  return (
    <main className="flex flex-col rounded-none max-w-[848px]" role="main">
      <section className="messages-container" aria-label="Chat messages">
        <div className="gap-2.5 self-end px-4 py-3 text-base bg-violet-100 rounded-xl text-neutral-900">
          Tell me a joke
        </div>
        ...
        <div className="flex gap-0.5 justify-center items-center self-end px-4 py-2.5 mt-10 bg-purple-100 rounded-xl">
          <button
